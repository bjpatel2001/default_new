/**
 * Created by Mobio Solutions on 30-05-2017.
 */
...
app.brochure = {
    ...
    events: {
        ...
        init: function () {
            app.brochure.events.switch();
            app.brochure.events.delete();
    ...
    init: function () {
        app.brochure.events.init();
        app.dataTable.custom({"url":'brochure/datatable'});
