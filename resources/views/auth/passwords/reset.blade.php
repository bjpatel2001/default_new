        ...
        <div class="main-content container-fluid">
            <div class="splash-container">
                <div class="panel panel-default panel-border-color panel-border-color-primary">
                    <div class="panel-heading img-resposive"><a href="{{url('admin/dashboard')}}"><img src="{{url('img/mainlogo.png')}}" alt="logo" width="102" height="27" class="logo-img" /></a><span class="splash-description">Reset Password</span></div>
