        ...
        <div class="main-content container-fluid">
            <div class="splash-container">
                <div class="panel panel-default panel-border-color panel-border-color-primary">
                    <div class="panel-heading img-resposive"><a href="{{url('admin/dashboard')}}"><img src="{{url('img/mainlogo.png')}}" alt="logo" width="102" height="27" class="logo-img"></a><span class="splash-description">{{trans('app.login_throttle')}}</span></div>
                    <div class="panel-body">
                        <form action="{{ url('/admin/login') }}" method="post">
                            ...
                            <div class="form-group row login-tools">
                                ...
                                <div class="col-xs-6 login-forgot-password"><a href="{{ url('/admin/password/reset') }}">{{trans('app.forgot_password')}}</a></div>
                            </div>
