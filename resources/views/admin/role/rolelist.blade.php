                    ...
                    <div class="col-sm-12 col-xs-12">
                        <div class="activity-but activity-space pull-left">
                            {{--<div class="addreport pull-right">
                                <a href="{{url('admin/role/add')}}"><button class="btn btn-space btn-primary btn-lg hover"><i class="icon mdi mdi-plus "></i>Add Role</button></a>
                            </div>--}}
                            <!--  <div class="btn-group ">
                                        ...
                                        @if(count($roleData) > 0)
                                            @foreach($roleData as $row)
                                                <tr>
                                                    ...
                                                    <td>{{$row->code}}</td>
                                                    <td>
                                                        <div class="icon pull-left"><a href="{{$baseUrl.'/admin/role/edit/'.$row->id}}"><span title="Edit" class="mdi mdi-edit"></span></a></div>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        @else
