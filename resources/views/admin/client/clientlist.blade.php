    ...
    <div class="be-content">
        <div class="page-head">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">{{trans('app.client')}} {{trans('app.list')}}</li>
            </ol>
        </div>
        <div class="main-content container-fluid">
            ...
            <div class="panel panel-default panel-border-color panel-border-color-primary pull-left">
                            ...
                            <div class="addreport pull-right">
                                <a href="{{url('admin/client/add')}}">
                                    <button class="btn btn-space btn-primary"><i
                                                class="icon mdi mdi-plus "></i> {{trans('app.add')}} {{trans('app.client')}}
                                    </button>
                                </a>
                            </div>
                        </div>
                ...
                <div class="deta-table client-table pull-left">
                    <div class="row">
                        <div class="col-sm-12">
...
@push('internalJsLoad')
<script>
    app.default.init({"route":{"url":'client/datatable'}});
</script>
@endpush