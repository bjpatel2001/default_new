    ...
    <div class="be-content">
        <div class="page-head">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">{{trans('app.add')}} {{trans('app.state')}}</li>
            </ol>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                        <div class="panel-heading panel-heading-divider">{{trans('app.add')}} {{trans('app.state')}}</div>
                        <div class="panel-body">
                            ...
                            @endif
                            <form action="{{url('admin/state/store')}}" enctype="multipart/form-data" name="app_add_form" id="app_form" style="border-radius: 0px;" method="post" class="form-horizontal group-border-dashed">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 col-md-4">
                                        <input type="text" name="name" id="name" placeholder="State Name" class="form-control input-sm required" value="{{old('name')}}" />
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-8 savebtn">
                                    <p class="text-right">
                                        <button type="submit" class="btn btn-space btn-info btn-lg">{{trans('app.add')}} {{trans('app.state')}}</button>
