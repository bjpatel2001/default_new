    ...
    <div class="be-content">
        <div class="page-head">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">{{trans('app.state')}} {{trans('app.list')}}</li>
            </ol>
        </div>
        <div class="main-content container-fluid">
            ...
            <div class="panel panel-default panel-border-color panel-border-color-primary pull-left">
                    ...
                    <div class="col-sm-12 col-xs-12">
                        <div class="activity-but activity-space pull-left">
                            ...
                            <div class="addreport pull-right">
                                <a href="{{url('admin/state/add')}}">
                                    <button class="btn btn-space btn-primary"><i
                                                class="icon mdi mdi-plus "></i> {{trans('app.add')}} {{trans('app.state')}}
                                    </button>
                                </a>
                            </div>
                        </div>
                ...
                <div class="deta-table state-table pull-left">
                    <div class="row">
                        <div class="col-sm-12">
                                    ...
                                    <div class="table-responsive">
                                        <table id="dataTable"
                                            ...
                                            <thead>
                                                 <tr>
                                                    <th>
                                                        <input type="text" name="filter[tbl_state.name]" id="name" value="" />
                                                    </th>
                                                     <th>
                                                        <input type="text" name="filter[tbl_country.name]" id="c_name" value="" />
                                                     </th>
                                                     <th>
...
@push('internalJsLoad')
<script>
    app.default.init({"route":{"url":'state/datatable'}});
