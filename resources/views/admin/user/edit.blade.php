                ...
                <div class="col-md-12">
                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                        ...
                        <div class="panel-body">
                            ...
                            @endif
                            <form action="{{url('admin/user/update')}}" name="app_edit_form" id="app_form" style="border-radius: 0px;" method="post" class="form-horizontal group-border-dashed">
                                ...
                                <div class="col-sm-6 col-md-8 savebtn">
                                    <p class="text-right">
                                        ...
                                        <a href="{{url('admin/user/list')}}" class="btn btn-space btn-danger btn-lg">Cancel</a>
                                    </p>
                                </div>
                            </form>
                        </div>
