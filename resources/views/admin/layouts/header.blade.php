<nav class="navbar navbar-default navbar-fixed-top be-top-header">
    <div class="container-fluid">
        <div class="navbar-header">
            <a href="{{url('admin/dashboard')}}" class="navbar-brand"></a><a href="javascript:void(0);" class="be-toggle-left-sidebar"><span
            ...
            <ul class="nav navbar-nav navbar-right be-user-nav">
                <li class="dropdown">
                    ...
                    <ul role="menu" class="dropdown-menu">
                        ...
                        <li><a href="{{url('admin/user/profile')}}"><span class="icon mdi mdi-face"></span> {{trans('app.my_profile')}}</a></li>
                        <li><a href="{{url('admin/change-password')}}"><span class="icon mdi mdi-lock"></span> {{trans('app.change_password')}}</a></li>
