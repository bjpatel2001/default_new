...
@section('content')
    <div class="be-content">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">{{trans('app.edit')}} {{trans('app.category')}}</li>
            </ol>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                        <div class="panel-heading panel-heading-divider">{{trans('app.edit')}} {{trans('app.category')}}</div>
                        <div class="panel-body">
                            ...
                            @endif
                            <form action="{{url('admin/category/update')}}" name="app_edit_form" id="app_form" style="border-radius: 0px;" method="post" class="form-horizontal group-border-dashed">

                                <div class="form-group">
                                    <label class="col-sm-4 control-label">Category Name <span class="error">*</span></label>
                                    <div class="col-sm-6 col-md-4">
                                        <input type="text" name="category_name" id="category_name" placeholder="Category Name" class="form-control input-sm required" value="{{$details->category_name}}" />
                                    </div>
                                </div>
