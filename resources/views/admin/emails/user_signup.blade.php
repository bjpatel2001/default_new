...
<html>
    <head>
        <title>Aviva : User Login Information</title>
        ...
        <div style="text-align: center;display: table-cell;vertical-align: middle;">
            <div style="width: 450px;margin: 0 auto;">
                <div style="text-align: center; border-bottom: 1px lightgrey solid;">
                    <span>
                        <a href="{{url('admin/dashboard')}}"><img src="{{url('img/logo.png')}}"/></a>
                    </span>
                </div>
                <div style="text-align: center;border-bottom: 1px lightgrey solid;">
                ...
                <div style=" text-align: center;display: inline-block;border-bottom: 1px lightgrey solid;">
                    ...
                    <p>Welcome to Aviva. Please find your login details below.</p>
