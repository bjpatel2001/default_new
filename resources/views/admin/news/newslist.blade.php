    ...
    <div class="be-content">
        <div class="page-head">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">{{trans('app.news')}} {{trans('app.list')}}</li>
            </ol>
        </div>
        <div class="main-content container-fluid">
            ...
            <div class="panel panel-default panel-border-color panel-border-color-primary pull-left">
                            ...
                            <div class="addreport pull-right">
                                <a href="{{url('admin/news/add')}}">
                                    <button class="btn btn-space btn-primary"><i
                                                class="icon mdi mdi-plus "></i> {{trans('app.add')}} {{trans('app.news')}}
                                    </button>
                                </a>
                            </div>
                        </div>
                ...
                <div class="deta-table news-table pull-left">
                    <div class="row">
                        <div class="col-sm-12">
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <table id="dataTable"
                                            ...
                                            <tr>
                                                <th>
                                                    <input type="text" name="filter[title]" id="title" value=""/>
                                                </th>
                                                <th>
...
@push('internalJsLoad')
<script>
    app.default.init({"route":{"url":'news/datatable'}});
</script>
@endpush