        ...
        <div class="main-content container-fluid">
            <div class="splash-container forgot-password">
                <div class="panel panel-default panel-border-color panel-border-color-primary">
                    <div class="panel-heading"><a href="{{url('admin/dashboard')}}"><img src="{{url('img/mainlogo.png')}}" alt="logo"  class="logo-img" /></a><span class="splash-description">Forgot your password?</span></div>
                    <div class="panel-body">
                        ...
                        @endif
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('app_password/email') }}">
                            {{ csrf_field() }}
