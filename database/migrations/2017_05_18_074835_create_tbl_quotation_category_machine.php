...
class CreateTblQuotationCategoryMachine extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        //
        Schema::create('tbl_quotation_category_machine', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        //
        Schema::drop('tbl_quotation_category_machine');
    }
}
