...
class CreateLogTblRequestedQuestion extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        //
        Schema::create('log_tbl_requested_question', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        //
        Schema::drop('log_tbl_requested_question');
    }
}
